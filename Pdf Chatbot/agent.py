...
document_path = "C:\\Users\\anike\\Downloads\\RP-1.pdf"
agent.ingest(document_path)
...
question = "Can you provide more details about the key findings?"
response = agent.ask(question)
print(f"Question: {question}\nAnswer: {response}")

# Test 4: Forget all knowledge
agent.forget()
